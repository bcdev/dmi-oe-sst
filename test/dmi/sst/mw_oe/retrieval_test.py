...
class RetrievalTest(unittest.TestCase):
    ...
    def test_run(self):
        ...
        self.assertAlmostEqual(0.9962128, result.AK.data[0, 0], 7)
        self.assertAlmostEqual(0.910339, result.AK.data[1, 1], 7)
        self.assertAlmostEqual(0.99998724, result.AK.data[2, 2], 7)
        ...
        self.assertAlmostEqual(0.89614433, result.tb_rmse.data[0], 7)
        self.assertAlmostEqual(0.43409148, result.tb_rmse.data[1], 7)
        self.assertAlmostEqual(0.3317858, result.tb_rmse.data[2], 8)

        self.assertEqual((3, 4), result.p.shape)
        self.assertAlmostEqual(13.069875, result.p.data[0, 0], 6)
        self.assertAlmostEqual(27.391582, result.p.data[1, 1], 5)
        self.assertAlmostEqual(0.120024666, result.p.data[2, 2], 8)
        ...
        self.assertAlmostEqual(98.216354, result.tb_sim.data[0, 3], 5)
        self.assertAlmostEqual(199.18938, result.tb_sim.data[1, 4], 5)
        self.assertAlmostEqual(115.8715, result.tb_sim.data[2, 5], 5)
